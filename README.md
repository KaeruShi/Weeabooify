...
- **Trial Version** — Free, with limited features for testing compatibility before purchase  
- **Full Version** — One-time purchase of **$5**, includes access to all features  

To purchase the full version, use one of the methods below:
...
<details>
<summary>🆓 Is there a Trial Version available?</summary>

- Trial Version is available for users who want to test Weeabooify before purchasing.
- It includes limited access to selected features for compatibility testing.
- You can upgrade to the full version anytime.
